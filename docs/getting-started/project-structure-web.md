...
![Platform Overview diagram](/img/webdemo2.2.png)
...
Contains browser drivers needed for automated browser testing:

- **chromedriver.exe:**  Driver for Chrome browser. 
- **geckodriver.exe:**  Driver for Firefox browser.
- **msedgedriver.exe :**  Driver for Microsoft Edge browser.
